var i18n_en = {
  ...
  diag_tool_arrow:
    "Arrow (click source → click target, or drag from a connection dot)",
  diag_tool_delete: "Delete selection (Del)",
  diag_tool_lock: "Lock diagram",
  diag_tool_unlock: "Unlock diagram",
  diag_first_save_error:
    "File not found. Select the folder containing <strong>diagrammes.js</strong>.",
